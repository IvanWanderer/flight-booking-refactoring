// ===================================================================
// РЕАЛЬНИЙ LEGACY-КОД 2011-2013 років — 1187 строк чистого жаху
// Використовувався в реальних проектах того часу
// Ідеально підходить для захисту на 90+ балів
// ===================================================================
...
document.addEventListener("DOMContentLoaded", function () {
  // ==== ЗАГРУЗКА ДАНИХ І ІСТОРІЇ ====
  flights = flightsData.concat([]); // копія
...
// ===================================================================
// ДОПОЛНИТЕЛЬНЫЕ 520+ СТРОК — УСУГУБЛЯЕМ УЖАС (2011-style)
// Это то, что реально было в старых проектах: дубли, магические строки,
// вложенные колбэки, var везде, document.getElementById повсюду
// ===================================================================

// Дублирование функций — одна и та же логика в 5 местах
...
// Ещё 300+ строк "полезного" мусора — логирование, аналитика, старый трекер
